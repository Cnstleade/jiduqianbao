        ...
        <el-table
          ...
          >
             ...
             width="55">   
                      ...
                      <el-table-column prop="typeStr" label="客户状态" align="center"  min-width="120"></el-table-column>
        ...
        <el-dialog
          ...
          > 
            ...
            <el-form :model="ruleForm1" status-icon  ref="ruleForm1" label-width="100px" :rules="rules" >
              ...
              <el-form-item label="客户状态:" prop="type" >
                <el-input v-model.number="ruleForm1.typeStr" disabled></el-input>
              </el-form-item>  
              <el-form-item label="所剩额度:" prop="money" >
                <el-input v-model.number="ruleForm1.money" disabled></el-input>
              </el-form-item>  
                ...
                <table class="table" >
                    ...
                    <tr class="title_6" >
                     ...
                     <el-table-column prop="salesmanName" label="电销人员" align="center"  width="100"></el-table-column>                      
                      ...
                      <el-table-column prop="promoter" label="渠道" align="center"  width="100"></el-table-column>
                  ...
                  <tr>
                        ...
                        <td colspan="5" >
                            <el-button class="m20" type="primary" @click="handleAdd()">通讯录信息</el-button>
                        </td>
                    </tr>                                    
                    <tr>
          ...
          >
            ...
            <el-form class="m20" :model="smsForm" status-icon  ref="smsForm" label-width="100px" :rules="rules" >
              ...
              <el-form-item>
                ...
                <el-button type="primary" style="margin-left:30px" @click="dialogVisibleSMS=false">取消</el-button>
              </el-form-item>                                    
            </el-form>            
        </el-dialog>                         
    </div>
